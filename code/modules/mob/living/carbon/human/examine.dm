...
//this is very slightly better than it was because you can use it more places. still can't do \his[src] though.
	...
	if(!appears_dead)
		...
		if(getorgan(/obj/item/organ/brain))
			if(!key)
				msg += "<span class='red'>[t_He] [t_is] totally catatonic. Any recovery is unlikely.</span>\n"
			else if(!client)
				msg += "<span class='red'>[t_He] [t_has] a blank, absent-minded stare and appears completely unresponsive to anything. [t_He] may snap out of it soon.</span>\n"
