...
GLOBAL_LIST_INIT(footstep, list(
	...
	FOOTSTEP_WATER = list(list(
		'sound/effects/footstep/tread_water1.ogg',
		'sound/effects/footstep/tread_water2.ogg',
		'sound/effects/footstep/tread_water3.ogg',
		'sound/effects/footstep/tread_water4.ogg',
		'sound/effects/footstep/tread_water5.ogg',
		'sound/effects/footstep/tread_water6.ogg'), 100, 1),
...
GLOBAL_LIST_INIT(heavyfootstep, list(
	...
	FOOTSTEP_WATER = list(list(
		...
		'sound/effects/footstep/tread_water4.ogg',
		'sound/effects/footstep/tread_water5.ogg',
		'sound/effects/footstep/tread_water6.ogg'), 100, 2),
	FOOTSTEP_LAVA = list(list(
		'sound/effects/footstep/lava1.ogg',
		'sound/effects/footstep/lava2.ogg',
		'sound/effects/footstep/lava3.ogg'), 100, 0),
