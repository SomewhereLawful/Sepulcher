...
/obj/item/construction/rcd/attack_self(mob/user)
	...
	var/list/choices = list(
		...
		"Grilles & Windows" = image(icon = 'icons/mob/screen/radial.dmi', icon_state = "grillewindow"),
		"Floors & Walls" = image(icon = 'icons/mob/screen/radial.dmi', icon_state = "wallfloor")
	)
	if(mode == RCD_AIRLOCK)
		choices += list(
		"Change Access" = image(icon = 'icons/mob/screen/radial.dmi', icon_state = "access"),
		"Change Airlock Type" = image(icon = 'icons/mob/screen/radial.dmi', icon_state = "airlocktype")
		)
	else if(mode == RCD_WINDOWGRILLE)
		choices += list(
			"Change Window Type" = image(icon = 'icons/mob/screen/radial.dmi', icon_state = "windowtype")
		)
